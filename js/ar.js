function arabic() {
    ...
    <h3><a href="index.html">أحمد الرقاص</a></h3>
    ...
    <h3><a href="index.html">أحمد </a></h3>
...
<li class="navMenuLink mt-5">
    <p>موبايل :
        <a href="tel:+967773637966" target="_blank" dir="ltr">
           (+967-773-637-966)
        </a>
    </p>
</li>
<li class="navMenuLink">
    <p>الايميل:
        <a href="mailto:ahmedzizz703@gmail.com" target="_blank">
            ahmedzizz703@gmail.com
        </a>
    </p>
</li>
`;
...
<a href="tel:+967773637966" class="btn-2" target="_blank">تواصل بي</a></div>`;
    ...
    <p class="about__bio"><strong>الاسم :</strong> أحمد الرقاص</p>
...
<ul>
    ...
    document.getElementById("Created_by").innerHTML = ` &copy; صنع بواسطة <a href="index.html">أحمد الرقاص</a>`;
...
<li class="navMenuLink mt-5">
    <p>Mobile:
        <a href="tel:+967773637966" target="_blank">
            (+967-773-637-966)
        </a>
    </p>
</li>
...
<div class="btn-box">
    ...
    <a href="tel:+967773637966" class="btn-2" target="_blank">
        Contact me
    </a>
</div>`;
    document.getElementById("about_title").innerHTML = `ABOUT <span class="title2"> ME</span>`;
    document.getElementById("about_title_co").innerHTML = ` My name is Ahmed, and I have studied Information Technology. I am a core tame of the developer community at Google, and I work as a freelancer in the field of web development and systems. I use various programming languages to create innovative solutions for my clients.`;
    ...
    <div class="col-md-6 col-lg-5">
    <p class="about__bio"><strong>NAME :</strong> Ahmed Alrages</p>
...
`;
    ...
    `;
    document.getElementById("Created_by").innerHTML = `  &copy; Created by <a href="index.html">Ahmed Alrages</a>`;
